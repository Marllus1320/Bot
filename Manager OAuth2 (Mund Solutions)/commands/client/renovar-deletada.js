...
module.exports = {
    name:"renovar-deletada",
    description:"Renove um dos seus Bots AUTH'S que foi deletada.",
    type: ApplicationCommandType.ChatInput,   
    run: async(client, interaction) => {
        const bot = interaction.options.getString("bot");
        await interaction.reply({content:`<a:loading:1225944483917725736> | Aguarde um momento...`, ephemeral:true});
        ...
        if(auths.length <= 0) return interaction.editReply({content:`<:erro:1225965265909710869> | Você não tem nenhum Auth Desativado.`});
